...
require (
	...
	github.com/open-telemetry/opentelemetry-tutorials/smart-data/smartdata v0.0.0
...
replace github.com/open-telemetry/opentelemetry-tutorials/smart-data/smartdata => ./receiver/smartdata
