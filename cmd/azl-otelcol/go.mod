...
require (
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/azuredataexplorerexporter v0.127.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/smartdatareceiver v0.127.0
